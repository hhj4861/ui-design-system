...
export function SignupForm({
  ...
  const t = { ...signupFormThemes.ngrok, ...theme };
  ...
  const getOAuthLabel = (provider: OAuthProvider, customLabel?: string) => {
    ...
    switch (provider) {
      case 'github': return 'Sign up with GitHub';
      case 'google': return 'Sign up with Google';
      case 'sso': return 'Sign up with SSO';
    }
  };
